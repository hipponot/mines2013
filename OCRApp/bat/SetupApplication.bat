...
:: Android packaging
set AND_CERT_NAME="OCR Project"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OCRProject.p12
...
set IOS_PROVISION=cert\OCRProject.mobileprovision
...
set APP_ID=air.nimbee.ocr.OCRProject

:: Output packages
set DIST_PATH=dist
set DIST_NAME=OCRProject
